...
import EZannot.detectron2  # noqa F401
from EZannot.detectron2.structures import Boxes, Instances
from EZannot.detectron2.utils.env import _import_file
...
def patch_builtin_len(modules=()):
    ...
    with ExitStack() as stack:
        MODULES = [
            "EZannot.detectron2.modeling.roi_heads.fast_rcnn",
            "EZannot.detectron2.modeling.roi_heads.mask_head",
            "EZannot.detectron2.modeling.roi_heads.keypoint_head",
        ] + list(modules)
...
def patch_nonscriptable_classes():
    ...
    from EZannot.detectron2.modeling.backbone import ResNet, FPN
    ...
    from EZannot.detectron2.modeling.roi_heads import StandardROIHeads
