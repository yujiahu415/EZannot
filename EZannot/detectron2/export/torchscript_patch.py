...
import Cellan.detectron2  # noqa F401
from Cellan.detectron2.structures import Boxes, Instances
from Cellan.detectron2.utils.env import _import_file
...
def patch_builtin_len(modules=()):
    ...
    with ExitStack() as stack:
        MODULES = [
            "Cellan.detectron2.modeling.roi_heads.fast_rcnn",
            "Cellan.detectron2.modeling.roi_heads.mask_head",
            "Cellan.detectron2.modeling.roi_heads.keypoint_head",
        ] + list(modules)
...
def patch_nonscriptable_classes():
    ...
    from Cellan.detectron2.modeling.backbone import ResNet, FPN
    ...
    from Cellan.detectron2.modeling.roi_heads import StandardROIHeads
